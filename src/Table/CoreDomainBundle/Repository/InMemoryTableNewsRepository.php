...
class InMemoryTableNewsRepository implements TableNewsRepository
{
    ...
    public function __construct()
    {
        $this->news[] = new TableNews(
                "1", '12/09/2013 23:22:22', '12/09/2013 23:22:22', 'Скидки', 'У нас сейчас скидки', array(
        ...
        $this->news[] = new TableNews(
                "2", '12/09/2013 23:22:22', '12/10/2013 23:22:22','Что-то новенькое', 'У нас сейчас что-то новенькое', array(
    ...
    {
        $news = new TableNews("1", '12/09/2013 23:22:22', '12/09/2013 23:22:22', "NEW!!!", "This is new!", array(
            "big" => "http://learningdesign.psu.edu/themes/site_themes/agile_records/images/uploads/LDImages/itsupport2.jpg",
            "small" => "http://static.environmentalgraffiti.com/sites/default/files/images/http-inlinethumb35.webshots.com-26146-2604528680104178106S600x600Q85.jpg"
                ), $id, "Dnepropetrovsk"
        );
    ...
    {
        $news[] = new TableNews("2", "12/09/2013 23:22:22", "12/09/2013 23:22:22", "NEW!!!", "This is new!", array(
            "big" => "http://learningdesign.psu.edu/themes/site_themes/agile_records/images/uploads/LDImages/itsupport2.jpg",
            "small" => "http://static.environmentalgraffiti.com/sites/default/files/images/http-inlinethumb35.webshots.com-26146-2604528680104178106S600x600Q85.jpg"
                ), "1", $city
        );
