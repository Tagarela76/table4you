...
namespace Application\Sonata\UserBundle\Security\Core\Authentication\Provider;
 ...
 */
abstract class CustomUserAuthenticationProvider implements  AuthenticationProviderInterface
{
    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('Bad credentials userName', 0, $notFound);
            }
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('Bad credentials password', 0, $e);
            }
